    ...
    <footer id="contact" className="bg-gray-900 text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">{branding?.logo?.text || 'MaLah'}</h3>
            <p className="text-gray-400 text-sm">
              Platform terpercaya untuk membuat undangan digital yang cantik dan fungsional.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>Email: {branding?.contact_email || 'info@malah.com'}</li>
              <li>Phone: {branding?.contact_phone || '+62 812-3456-7890'}</li>
              <li>Address: {branding?.contact_address || 'Jakarta, Indonesia'}</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {branding?.social_facebook && (
                <a href={branding.social_facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              ...
              {branding?.social_instagram && (
                <a href={branding.social_instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {branding?.social_twitter && (
                <a href={branding.social_twitter} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-center text-gray-400 text-sm">
            &copy; 2024 {branding?.logo?.text || 'MaLah'}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
